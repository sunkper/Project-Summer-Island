...
onready var panorama_day = preload("res://assets/sky/Epic_BlueSunset_EquiRect_flat_1024.png")
onready var panorama_night = preload("res://assets/sky/Epic_GloriousPink_EquiRect.png")
